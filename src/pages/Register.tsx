...
import { registerUser } from '../redux/featured/user/registrationSlice';
...
<form className="mt-6" onSubmit={handleSubmit}>
  ...
  {isLoading ? <p>Registering...</p>: <button className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
      Sing-up
    </button>}
