...
export default function Register() {
  return (
    ...
    <form className="mt-6">
        <div>
            <label htmlFor="username" className="block text-sm text-gray-800 text-left dark:text-gray-200">Email</label>
   ...
   <p className="mt-8 text-xs font-light text-center text-gray-400"> Already   have an account? <Link to='/login'><a href="#" className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Login</a></Link> </p>
</div>
  )
}
