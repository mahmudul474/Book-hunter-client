...
import { loginUser, registerUser } from '../redux/featured/user/registrationSlice';
...
<form className="mt-6" onSubmit={handleSubmit}>
  <div>
    <label
      htmlFor="email"
      className="block text-sm text-gray-800 text-left dark:text-gray-200"
    >
      Email
    </label>
    <input
  ...
  {isLoading ? <p>login .....</p>: <button className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-gray-800 rounded-lg hover:bg-gray-700 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50">
      Login
    </button>}
