...
import { removeFromWishlist, updateWishlistStatus } from "../redux/featured/book/bookSlice";
...
const dispatch=useAppDispatch()
  ...
  const handleUpdateWishlistStatus = (bookId: string, status: 'toRead' | 'reading' | 'finished') => {
...
<div className="flex flex-col space-y-3">
              <button className="btn" onClick={() => handleRemoveFromWishlist(book._id)}>Remove from Wishlist
            </button>
    <button className="btn" onClick={() => handleUpdateWishlistStatus(book._id, 'toRead')}>ark as Reading
            </button>
            <button className="btn" onClick={() => handleUpdateWishlistStatus(book._id, 'finished')}>
              Mark as Finished
            </button>
